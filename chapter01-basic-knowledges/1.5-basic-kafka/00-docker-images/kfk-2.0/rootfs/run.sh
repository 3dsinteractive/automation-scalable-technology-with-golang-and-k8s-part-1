...
START_COMMAND="${KAFKA_HOME}/bin/kafka-server-start.sh ${KAFKA_HOME}/config/server.properties --override connections.max.idle.ms=-1 --override group.initial.rebalance.delay.ms=3000"
